 ...
 * @LastEditors: GanYong
 * @LastEditTime: 2021-03-30 15:07:11
-->
<template>
  <div id="app">
    <div>
      <!-- <table-form-head :formData="formData" :formList="formList" :rules="rules" @formChange="formChange"></table-form-head> -->
      <table-form
        :title="Title1"
        :dataIndex="data1"
        defaultRow="1"
        ...
        isShowAdd="false"
        @getTableFormData="getdata1"></table-form>
      <table-form
        :title="Title2"
        :dataIndex="data2"
        defaultRow="1"
        ...
        isShowAdd="true"
        @getTableFormData="getdata2"></table-form>
        <table-form
        :title="Title3"
        :dataIndex="data3"
        defaultRow="0"
        isShowAdd="true"></table-form>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      defaultdata1: [ { name: 'default-1', price: '' }, { name: 'default-2' }, { name: 'default-3' }, { name: 'default-4' }, { name: 'default-5' }, { name: 'default-6' } ]
    }
  },
  mounted () {
    // 模拟异步获取select列表数据
  ...
  methods: {
    ...
    filterData (data) {
      return data.filter((item) => {
        if (Object.keys(item).every((key) => { return item[key] })) {
          return item
        }
      })
    },
